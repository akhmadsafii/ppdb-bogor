                ...
                <div class="widget-bg">
                    <div class="widget-heading clearfix">
                        <form id="formSubmit">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group text-center">
                                        @php
                                            ...
                                            if ($page && $page['file'] != null) {
                                                $img = Helper::showImage('thumb/' . $page['file']);
                                            }
                                        @endphp
                                        <img id="image-preview" src="{{ $img }}" alt="Preview" height="150px">
                                        <p class="text-muted">*Direkomendasikan ukuran gambar 1.000 x 750 untuk hasil yang terbaik
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Isi</label>
                                <textarea name="content" id="content" class="editor" rows="3">{{ $page ? $page['content'] : '' }}</textarea>
                            </div>
                            <div class="btn-list">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('body').on('submit', '#formSubmit', function(e) {
                    ...
                    formData.append( 'link', '{{ request()->segment(3) }}');
                    $.ajax({
                        type: "POST",
                        url: "{{ route('pages.send') }}",
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
