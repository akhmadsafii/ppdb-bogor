                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="l30">Username <span class="text-red">*) Tidak bisa
                                                diedit</span></label>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="religion" placeholder="Agama Admin" name="religion"
                                            type="text" value="{{ $admin['religion'] }}">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="phone" placeholder="Telepon Admin"
                                            name="phone" type="text" value="{{ $admin['phone'] }}">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select name="gender" id="gender" class="form-control">
                                            <option value="male" {{ $admin['gender'] == 'male' ? 'selected' : '' }}>Laki -
                                                laki</option>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('body').on('submit', '#formAdmin', function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('account_admin.update_profile') }}",
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                $('#formPassword').on('submit', function(event) {
                    ...
                    $.ajax({
                        url: "{{ route('account_admin.update_password') }}",
                        method: "POST",
                        data: $(this).serialize(),
                        dataType: "json",
