...
@section('content')
    ...
    <div class="page-title clearfix">
        <a href="{{ route('setting.template.card') }}" class="mx-3"><i class="fas fa-wrench"></i> Pengaturan Template
            Kartu</a> |<a class="mx-3"><i class="fas fa-tasks"></i> Pengaturan
            Form
            Kartu</a>
    </div>
                                                            ...
                                                            <div class="checkbox">
                                                                <label class="checkbox-checked">
                                                                    <input type="checkbox" name="select-all" id="select-all"
                                                                        class="select-all"
                                                                        onchange="selectBox(this, {{ $typ['id'] }})">
                                                                ...
                                                                <div class="checkbox ml-4">
                                                                    <label>
                                                                        ...
                                                                        <input type="checkbox" id="option_check"
                                                                            ...
                                                                            value="1"
                                                                            @if ($child['status_card'] == 1) checked="checked" @endif>
                                                                        <span
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('body').on('submit', '#formSubmit', function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('form.card_update_checked') }}",
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
