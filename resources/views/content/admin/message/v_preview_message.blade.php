...
@section('content')
    ...
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <a href="{{ route('message') }}"><i class="fas fa-chevron-left"></i> Kembali ke Pesan</a>
        </div>
        <div class="page-title-right d-inline-flex">
                            ...
                            <div class="w-100 p-2" style="background: #f2f4f8;">
                                @php
                                    ...
                                    if (Auth::guard('admin')->user()->file != 'user.png') {
                                        $img_response = Helper::showImage(Auth::guard('admin')->user()->file);
                                    }
                                @endphp
                                <div class="d-flex">
                                    <div class="my-auto">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.formSubmit').on('submit', function(event) {
                    ...
                    $.ajax({
                        url: "{{ route('response-message.send') }}",
                        method: "POST",
                        data: $(this).serialize(),
                        dataType: "json",
